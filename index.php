...
$beta = mysqli_query($koneksitest, "SELECT * from air WHERE arah = 'keluar' order by 'date' desc limit 13");
$barchart = mysqli_query($koneksitest, "SELECT * from harian2 order by 'id' asc");
$kualitas = mysqli_query($koneksitest, "SELECT * from kualitas order by 'date' desc limit 1");

//Persiapan Array untuk melakukan array push
$arr = array(); //array untuk debit air
$time = array(); //array untuk waktu
$vol = array(); //array untuk volume total yang telah lewat
$volhari = array(); //array untuk volume dalam satu hari
$VolTanggal = array(); //array untuk waktu volume
$tds = array(); //array kualitas air berupa tds
$tss = array(); //array kualitas air berupa tss
$ph = array(); //array kualitas air berupa ph
                        ...
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    Total Penggunaan Air Minggu Ini (L)
                                </div>
